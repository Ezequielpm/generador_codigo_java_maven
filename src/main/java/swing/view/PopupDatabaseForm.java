 ...
 * @author mariormoreno
 */
public class PopupDatabaseForm extends javax.swing.JFrame {

    /**
     * Creates new form PopupDatabaseForm
     */
    public PopupDatabaseForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupDatabaseForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupDatabaseForm().setVisible(true);
            }
        });
    }
