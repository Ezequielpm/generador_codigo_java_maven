...
import controller.PopupDialogDeleteController;
...
public class PopupDialogDelete extends javax.swing.JDialog {
     ...
     */
    public PopupDialogDeleteController objDialogDeleteController;

    public PopupDialogDelete(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.objDialogDeleteController = new PopupDialogDeleteController(this);
    ...
    private void initComponents() {
        ...
        deleteButton.setFont(new java.awt.Font("Helvetica Neue", 0, 24)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupDialogDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopupDialogDelete dialog = new PopupDialogDelete(new javax.swing.JFrame(), true);
