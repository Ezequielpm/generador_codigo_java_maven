 ...
 * @author mariormoreno
 */
public class MainDashboardModified extends javax.swing.JFrame {

    /**
     * Creates new form MainDashboard
     */
    public MainDashboardModified() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainDashboardModified.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainDashboardModified().setVisible(true);
            }
        });
    }
